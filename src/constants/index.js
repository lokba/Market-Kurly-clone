...
export const mainBannerInfo = [
    "장바구니 자랑하면 5천원의 행운이 매일!", "일 20분께 드리는 적립금 혜택!"
];

export const mainHomeBannerImgs = [
    "/images/banner/icecream.png",
    "/images/banner/shipping.png"
];

export const mainHomeSectionTitles = [
    {
        title: "이 상품 어때요?",
    },
    {
